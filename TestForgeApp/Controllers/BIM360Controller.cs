...
namespace bim360issues.Controllers
{
    public class BIM360Controller : ControllerBase
    {
        ...
        public async Task<IRestResponse> GetUsers(string accountId)
        {
            ...
            dynamic bearer = await oauth.AuthenticateAsync(AppSettings.GetAppSetting("FORGE_CLIENT_ID"), AppSettings.GetAppSetting("FORGE_CLIENT_SECRET"), "client_credentials", new Scope[] { Scope.AccountRead });
